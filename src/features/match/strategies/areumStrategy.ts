...
참고 직종군 (한국장애인개발원·장애인고용공단 실제 직무 기준):
- 사무: 사무보조, 행정보조, 우편분류, 문서파기, 데이터 입력, 콘텐츠 모니터링
- 제조·생산: 부품 조립, 물품 포장, 제품 검사, 라벨 부착, 비누 제조, 의류 제조
- 서비스·유통: 바리스타, 상품 진열, 매장 안내, 객실관리, 서점 도서 정리, 스포츠시설 안내
- 공공·복지: 사서보조, 환경미화, 주차 안내, 병원 안내, 재래시장 관리
- 식품·돌봄: 제과제빵, 급식 지원, 식품 가공, 실버케어, 영유아 돌봄, 물리치료보조
- 환경·정리: 환경 정리, 세탁, 방역·소독, 다회용품 세척, 공공자전거 세척
- IT·디지털: 데이터 라벨링, 콘텐츠 검수, 영상 편집, 소프트웨어 테스트
