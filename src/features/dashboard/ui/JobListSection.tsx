    ...
    <section aria-labelledby="job-list-heading">
      ...
      {!isLoading &&
        ...
        (onSelectSigungu || onSelectFitLevel) && (
          <p className="mb-4 flex items-center gap-1 text-[0.875rem] text-gray-400">
            <Info
              size={14}
              strokeWidth={1.5}
              aria-hidden="true"
      ...
      {/* 칩 필터만 sticky — 뷰포트 전체 너비 */}
      <div
        className="sticky top-14 z-10 border-b border-[var(--color-border)] bg-[var(--color-bg)] md:top-[72px]"
        style={{ width: '100vw', marginLeft: 'calc(50% - 50vw)' }}
      >
        <div className="mx-auto max-w-[1200px] px-4 py-3 md:px-5 lg:px-6">
